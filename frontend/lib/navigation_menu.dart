...
import 'package:flutter_elearning_project/features/course/screens/course.dart';
import 'package:flutter_elearning_project/features/document/screens/main_doc.dart';
import 'package:flutter_elearning_project/features/exam/screens/practice_test.dart';
        ...
        () => NavigationBar(
          ...
          destinations: const [
            ...
            NavigationDestination(
                icon: Icon(Iconsax.element_3), label: "Khóa học"),
            NavigationDestination(
                icon: Icon(Iconsax.task_square), label: "Luyện thi"),
            NavigationDestination(
                icon: Icon(Iconsax.folder_2), label: "Tài liệu"),
...
class NavigationController extends GetxController {
  // class từ GetX giúp quản lý trạng thái.
  ...
  final screens = [
    ...
    const MainDocScreen(),
    /*Container(color: Colors.yellow)*/ const SettingScreen()
  ];
}
