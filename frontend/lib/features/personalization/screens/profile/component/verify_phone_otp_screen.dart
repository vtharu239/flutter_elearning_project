...
class VerifyPhoneOtpScreen extends StatefulWidget {
  ...
  @override
  VerifyPhoneOtpScreenState createState() => VerifyPhoneOtpScreenState();
}

class VerifyPhoneOtpScreenState extends State<VerifyPhoneOtpScreen> {
  ...
  Future<void> _completePhoneChange() async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse(ApiConstants.getUrl('/profile/complete-phone-change')),
        headers: {
          ...ApiConstants.getHeaders(),
          'Authorization': 'Bearer $token',
        },
        body: jsonEncode({
          'newPhoneNo': widget.newPhoneNo,
          'idToken': idToken,
        }),
      );
          ...
          children: [
            ...
            RichText(
              text: TextSpan(
                ...
                children: [
                  const TextSpan(
                    text: 'Nhập mã OTP đã gửi đến số điện thoại ',
                  ),
                  TextSpan(
                    text: widget.newPhoneNo, // Phần có màu xanh
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                onPressed: isLoading ? null : _completePhoneChange,
                child: isLoading
